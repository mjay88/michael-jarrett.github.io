 ...
 */
//i : any value
//o: return the values type as a string
//c: difference between object and array
_.typeOf = function (value) {
  ...
  if (Array.isArray(value)) {
    ...
    //return appropriate string
    return "null";
    //all other cases should be handled with output of typeof operator
  } else {
    return typeof value;
  }
};
 ...
 *   _.first(["a", "b", "c"], 2) -> ["a", "b"]
 */
//should take in an array and a number
_.first = function (array, number) {
  //if the array is not an array, return empty array
  if (!Array.isArray(array)) return [];
  //if the array is empty, return it
  if (array.length === 0 || number < 0) return [];
  //if number arg is not a number, or undefined or null, return the first element of the array
  if (typeof number !== "number" || number === undefined || number === null)
    return array[0];
  //if number is greater than length of array return the entire array
  if (number > array.length - 1) return array;
  //otherwise, return 'number' amount of elements, use slice? or something similar
 ...
 *   _.last(["a", "b", "c"], 2) -> ["b", "c"]
 */
//create function, should take an array and a number
_.last = function (array, number) {
  //if the array is not an array, return empty array
  if (!Array.isArray(array)) return [];
  //if the array is empty, return it
  if (array.length === 0 || number < 0) return [];
  //if number arg is not a number, or undefined or null, return the last element of the array
  if (typeof number !== "number" || number === undefined || number === null)
 ...
 *   _.indexOf(["a","b","c"], "d") -> -1
 */
//create function, it should take an array and a value
//constraints : can not use indexOf
_.indexOf = function (array, value) {
  //iterate through the array, use for loop to access index, and return the first occurance of the value
  ...
  //return -1 if we iterate through entire array value is not in array
  return -1;
};
/** _.contains
 * Arguments:
...
_.each = function (collection, func) {
  ...
  if (Array.isArray(collection)) {
    ...
    for (let i = 0; i < collection.length; i++) {
      //call the callback function passing the element, the index, and the entire collection
    ...
    for (let key in collection) {
      //call the callback function on the each elements property value, key, and the entire collection
